...
This skill wraps the open-source AXe CLI (https://github.com/cameroncooke/AXe). Keep the local copy aligned to that repo and always target a simulator UDID so the iOS team can rely on consistent simulator automation.
